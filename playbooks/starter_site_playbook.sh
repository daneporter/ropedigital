...
#Update URL to https:
sudo -u $usr_name -i -- wp option update home $subdomain --path=/srv/users/$usr_name/apps/$app_name/public/
sudo -u $usr_name -i -- wp option update siteurl $subdomain --path=/srv/users/$usr_name/apps/$app_name/public/
