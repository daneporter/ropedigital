...
sudo -u $usr_name -i -- wp plugin install "https://github.com/daneporter/ropedigital/blob/master/starter-sites/plugins/astra-addon-plugin-2.2.4.zip" --activate --path=/srv/users/$usr_name/apps/$app_name/public/
sudo -u $usr_name -i -- wp plugin install "https://github.com/daneporter/ropedigital/blob/master/starter-sites/plugins/astra-premium-sites-1.4.5.zip" --activate --path=/srv/users/$usr_name/apps/$app_name/public/
