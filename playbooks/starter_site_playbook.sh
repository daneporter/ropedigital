...
sudo -u $usr_name -i -- wp option update blogdescription "Another WordPress Site <a href="https://ropedigital.com.au">Created with ReadyPress</a>" --path=/srv/users/$usr_name/apps/$app_name/public/
